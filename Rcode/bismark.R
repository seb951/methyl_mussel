...
#list all sequences
system("ls 001_fastq_compressed_files/*R1.fastq.gz >sequences")
...
for(i in 1:nrow(sequences))
{
 ...
 bismark_methylation_extractor = paste("/home/renaut/bismark_v0.20.1/bismark_methylation_extractor --samtools_path /cvmfs/soft.computecanada.ca/easybuild/software/2017/avx2/Compiler/intel2016.4/samtools/1.9/bin/samtools --gzip --bedGraph ",methyl_extract,sep = "")
 ...
 system("rm *unpaired.fq *trimmo.log *fastq")  
 
 #move into a specific bismark folder
 mv = paste("mv *",strsplit(seq,"_R1")[[1]][1],"*  bismark/.",sep = "")
 system(mv)
